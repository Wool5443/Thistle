...
#define INTEGER(num) (node_ctor((Node_data){ .type = NODE_INTEGER, .integer = num }, NULL, NULL))
#define FLOATING(num) (node_ctor((Node_data){ .type = NODE_FLOAT, .floating = num }, NULL, NULL))
